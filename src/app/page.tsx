...
export default function Home() {
	return (
		<main className='flex items-center justify-center flex-col gap-[80px] h-screen bg-[#0f0f0f]'>
			<p className='text-[#494136]'>Made with GSAP:</p>
			<div className='flex gap-[50px]'>
				<GsapMagnetic>
					<svg
						className='h-[50px] fill-[#c8bdb0] transition-all duration-200 cursor-pointer hover:fill-[#ec4e39]'
						id='Layer_2'
						data-name='Layer 2'
